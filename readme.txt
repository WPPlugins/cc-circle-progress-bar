...
Simple circle animated progressbar. It will Show any progress data by animation.
...
**Usages**
Just use <b>`[progressbar]`</b> short code.

Simple usage instruction:
1. Install This plug in your WordPress Site

2. Usage <b>`[progressbar]`</b> this shortcode where you want to use it.
...
5. If you have any problem to use this plugin feel free to submit a ticket in plug in forum.
